...
train_loader = SyntheticCharacterLoader('/content/SyntheticCharacters/train')
val_loader = SyntheticCharacterLoader('/content/SyntheticCharacters/val', batch_size=1024)
